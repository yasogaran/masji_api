...
describe('PeopleService', () => {
    ...
    beforeEach(async () => {
        ...
        service = module.get(people_service_1.PeopleService);
    });
    afterEach(() => {
        jest.clearAllMocks();
    });
    describe('findAll', () => {
        ...
        it('should search by name, NIC, or phone', async () => {
            ...
            expect(prisma.person.findMany).toHaveBeenCalledWith(expect.objectContaining({
    ...
    describe('update', () => {
        ...
        it('should throw NotFoundException when person not found', async () => {
            prisma.person.findUnique.mockResolvedValue(null);
            await expect(service.update('non-existent', { fullName: 'Test' })).rejects.toThrow(common_1.NotFoundException);
        });
        it('should throw BadRequestException if updating to existing NIC', async () => {
            ...
            prisma.person.findUnique
                ...
                .mockResolvedValueOnce({ ...mockPerson, id: 'person-2', nic: '987654321V' });
            await expect(service.update('person-1', updateDto)).rejects.toThrow(common_1.BadRequestException);
        });
