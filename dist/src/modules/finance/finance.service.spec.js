...
describe('FinanceService', () => {
    ...
    describe('getIncomeCategoryById', () => {
        ...
        it('should throw NotFoundException if category not found', async () => {
            ...
            await expect(service.getIncomeCategoryById('nonexistent')).rejects.toThrow(common_1.NotFoundException);
        });
    });
    ...
    describe('getIncomeById', () => {
        ...
        it('should throw NotFoundException if income not found', async () => {
            ...
            await expect(service.getIncomeById('nonexistent')).rejects.toThrow(common_1.NotFoundException);
        });
    });
    ...
    describe('deleteIncome', () => {
        ...
        it('should throw NotFoundException if income not found', async () => {
            mockPrismaService.income.findUnique.mockResolvedValue(null);
            await expect(service.deleteIncome('nonexistent')).rejects.toThrow(common_1.NotFoundException);
        });
    });
    ...
    describe('getExpenseById', () => {
        ...
        it('should throw NotFoundException if expense not found', async () => {
            ...
            await expect(service.getExpenseById('nonexistent')).rejects.toThrow(common_1.NotFoundException);
        });
    });
