...
export declare class ZakathController {
    ...
    createPeriod(dto: CreateZakathPeriodDto, user: any): Promise<{
        id: string;
        createdAt: Date;
        createdBy: string | null;
        name: string;
    ...
    completeCycle(id: string, dto: CompleteCycleDto, user: any): Promise<{
        id: string;
        createdAt: Date;
        createdBy: string | null;
        name: string;
    ...
    createCollection(dto: CreateZakathCollectionDto, user: any): Promise<{
        donor: {
            id: string;
            fullName: string;
        };
    ...
    approveRequest(id: string, dto: ApproveRequestDto, user: any): Promise<{
        id: string;
        notes: string | null;
        createdAt: Date;
        status: string;
    ...
    rejectRequest(id: string, dto: RejectRequestDto, user: any): Promise<{
        id: string;
        notes: string | null;
        createdAt: Date;
        status: string;
    ...
    createDistribution(dto: CreateZakathDistributionDto, user: any): Promise<{
        id: string;
        notes: string | null;
        createdAt: Date;
        amount: import("@prisma/client/runtime/library").Decimal;
