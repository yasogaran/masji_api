...
export declare class MahallasController {
    private mahallasService;
    constructor(mahallasService: MahallasService);
    findAll(): Promise<{
        _count: {
            families: number;
            people: number;
    ...
    create(createMahallaDto: CreateMahallaDto, userId: string): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        createdBy: string | null;
