...
describe('MosquesService', () => {
    ...
    beforeEach(async () => {
        ...
        const module = await testing_1.Test.createTestingModule({
            providers: [
                mosques_service_1.MosquesService,
                {
        ...
        service = module.get(mosques_service_1.MosquesService);
    });
    afterEach(() => {
        jest.clearAllMocks();
    });
    ...
    describe('update', () => {
        ...
        it('should throw NotFoundException when mosque not found', async () => {
            prisma.mosque.findUnique.mockResolvedValue(null);
            await expect(service.update('non-existent', { name: 'Test' })).rejects.toThrow(common_1.NotFoundException);
        });
        ...
        it('should throw BadRequestException when changing to parent and one exists', async () => {
            ...
            prisma.mosque.findUnique.mockResolvedValue(mockMosque);
            prisma.mosque.findFirst.mockResolvedValue(mockParentMosque);
            await expect(service.update('mosque-1', updateDto)).rejects.toThrow(common_1.BadRequestException);
        });
    ...
    describe('delete', () => {
        ...
        it('should throw BadRequestException when mosque has role assignments', async () => {
            ...
            await expect(service.delete('mosque-1')).rejects.toThrow(common_1.BadRequestException);
...
//# sourceMappingURL=mosques.service.spec.js.map