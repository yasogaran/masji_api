...
describe('DonationsService', () => {
    ...
    beforeEach(async () => {
        ...
        service = module.get(donations_service_1.DonationsService);
    ...
    describe('getDonationById', () => {
        ...
        it('should throw NotFoundException if donation not found', async () => {
            ...
            await expect(service.getDonationById('nonexistent')).rejects.toThrow(common_1.NotFoundException);
        });
    });
    describe('createDonation', () => {
        it('should create a money donation', async () => {
            const createDto = {
                categoryId: '1',
                donationType: donation_dto_1.DonationType.MONEY,
                amount: 5000,
        ...
        it('should create a goods donation', async () => {
            const createDto = {
                categoryId: '1',
                donationType: donation_dto_1.DonationType.GOODS,
    ...
    describe('deleteDonation', () => {
        ...
        it('should throw NotFoundException if donation not found', async () => {
            mockPrismaService.donation.findUnique.mockResolvedValue(null);
            await expect(service.deleteDonation('nonexistent')).rejects.toThrow(common_1.NotFoundException);
        });
    });
    ...
    describe('createDistribution', () => {
        it('should create a distribution', async () => {
            const createDto = {
                categoryId: '1',
                distributionType: donation_dto_1.DonationType.MONEY,
                amount: 5000,
...
//# sourceMappingURL=donations.service.spec.js.map