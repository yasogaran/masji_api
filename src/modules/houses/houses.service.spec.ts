...
describe('HousesService', () => {
  ...
  describe('update', () => {
    ...
    it('should throw NotFoundException when house not found', async () => {
      ...
      await expect(
        service.update('non-existent', { addressLine1: 'Test' }),
  ...
  describe('delete', () => {
    ...
    it('should throw BadRequestException when house has people', async () => {
      ...
      await expect(service.delete('house-1')).rejects.toThrow(
        BadRequestException,
      );
  ...
  describe('getHouseMembers', () => {
    it('should return families with members and all members', async () => {
      ...
      expect(result.families[0].memberCount).toBe(2); // family head + 1 member
    ...
    it('should throw NotFoundException when house not found', async () => {
      ...
      await expect(service.getHouseMembers('non-existent')).rejects.toThrow(
        NotFoundException,
      );
    });
  });
