...
describe('BoardService', () => {
  ...
  describe('getTermById', () => {
    ...
    it('should throw NotFoundException when term not found', async () => {
      ...
      await expect(service.getTermById('non-existent')).rejects.toThrow(NotFoundException);
    });
  });
  ...
  describe('deleteTerm', () => {
    ...
    it('should throw BadRequestException when term has members', async () => {
      ...
      await expect(service.deleteTerm('term-1')).rejects.toThrow(BadRequestException);
  ...
  describe('addMember', () => {
    ...
    it('should throw BadRequestException when person already has role in term', async () => {
      ...
      await expect(service.addMember(addDto)).rejects.toThrow(BadRequestException);
